...
(function (Hokuto) {
    ...
    let enshutsu_lose_table = [5000, 20000, 40000];
    let enshutsu_lose_message_table = [
        ['リオウ', 'パンチ', 'ドガッ', '貴様のチカラはその程度か。', 'ぐはっ'],
        ['リオウ', 'キック', 'ドガッ', '貴様のチカラはその程度か。', 'ぐはっ'],
        ['リオウ', '掌底拳', 'ボワーーー', '貴様のチカラはその程度か。', 'ぐはっ'],
    ];
    let enshutsu_ending_message_list = [
        '次の一撃が最後となるだろう',
        'やられろ　コンシロウ!!<br>ウォーター',
        'ば･･･ばかな･･･!!',
